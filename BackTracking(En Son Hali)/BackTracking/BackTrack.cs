                ...
                foreach( Time t in Courses[i].PossibleTimes)
                {
                    ...
                    if (BreakLoop == true)
                    {
                        ...
                        for (delete_i = 0; delete_i < Courses.Count(); delete_i ++)
                        {
                            ...
                            {
                                if (t.Begin == Courses[delete_i].PossibleTimes[delete_j].Begin && t.End == Courses[delete_i].PossibleTimes[delete_j].End && t.Day == Courses[delete_i].PossibleTimes[delete_j].Day)
                                {
                                    delete_check = true;
                                    break;
                                }
